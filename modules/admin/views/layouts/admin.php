...
use app\assets\ltAppAsset; // первый способ

AppAsset::register($this);
ltAppAsset::register($this); // первый способ
?>
<?php $this->beginPage() ?>
...
<head>
    ...
    <?php // второй способ
//        $this->registerJsFile('js/html5shiv.js', ['position' => \yii\web\View::POS_HEAD, 'condition' => 'lte IE 9']); 
//        $this->registerJsFile('js/respond.min.js', ['position' => \yii\web\View::POS_HEAD, 'condition' => 'lte IE 9']); 
    ?>
                        ...
                        <ul class="nav navbar-nav collapse navbar-collapse">
                            ...
                            <li class="dropdown"><a href="#">Категории<i class="fa fa-angle-down"></i></a>
                                <ul role="menu" class="sub-menu">
                                    ...
                                    <li><a href="<?= \yii\helpers\Url::to(['category/create'])?>">Добаить категорию</a></li>
...
<div class="container">
    ...
    <?php endif; ?>
<?= $content; // отсюда все вырезали и переместили в views/site/index?>
</div>
